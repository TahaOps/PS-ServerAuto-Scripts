...
# TASK - Log the version of Powershell
WriteToLog -AddLine "PowerShell version : $($PSVersionTable.PSVersion)"

# VARIABLES - Getting the current location and the files names
$CurrentLocation = Get-Location
$Files = @("Server_Setup.ps1","Domain_Merger.ps1", "Role_Installation.ps1")
